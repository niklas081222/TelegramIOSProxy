...
echo "  [4/13] Enabling auto-incoming translation state..."
...
echo "  [5/13] Patching ChatControllerLoadDisplayNode.swift for outgoing translation..."
...
# 13. Apply any additional .patch files
